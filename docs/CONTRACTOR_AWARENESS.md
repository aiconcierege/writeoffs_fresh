...
The versioned `contractor-awareness:v1` outcome is deliberately conservative. Unknown payment methods produce **Information incomplete**. Missing W-9 evidence produces **W-9 needed**. A supported cumulative amount with known methods and W-9 evidence may produce **Potential 1099 attention**, never a definitive filing statement. Entity status, payment nature, third-party reporting details, and the applicable complete rule set remain required before any future definitive conclusion.
