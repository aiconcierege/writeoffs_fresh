...
describe('transaction-first weekly review',()=>{
 ...
 it('shows snapshot summary before restrained transaction detail and uses review language',()=>{
  expect(weekly).toContain('<summary>Review transactions</summary>')
  expect(weekly.indexOf('home-review-totals')).toBeLessThan(weekly.indexOf('<summary>Review transactions</summary>'))
