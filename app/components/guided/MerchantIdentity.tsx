...
export function MerchantIdentity({merchant,date,amountCents,compact=false,id}:{id?:string;merchant:string;date?:string|null;amountCents?:number|null;compact?:boolean}){
