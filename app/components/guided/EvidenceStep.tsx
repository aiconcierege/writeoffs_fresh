...
export function EvidenceStep({action,busy,perform,onPending,showIntroduction=true}:{showIntroduction?:boolean;action:WorkAction;busy:boolean;perform:(fn:()=>Promise<GuidedWorkProjection|void>,deferred?:boolean)=>Promise<void>;onPending:(pending:boolean,message?:string)=>void}){
