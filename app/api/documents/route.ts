...
export async function POST(request:Request){
 ...
 const result=await db.rpc('register_customer_document',{p_id:b.id,p_fingerprint:b.fingerprint,p_name:b.name,p_mime:b.mime,p_bytes:b.bytes})
