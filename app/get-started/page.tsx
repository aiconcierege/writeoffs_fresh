...
export default async function GetStartedPage() {
  ...
  const [{ data: connections }, { data: accounts }, { data: cadence }, { data: accountUses }] = await Promise.all([
  ...
  return <main className="app-page"><div className="page-container page-container-narrow">
    <GetStartedFlow enabled={plaidLinkEnabled()} sandbox={plaidEnvironment()==='sandbox'} initialCheckInWeekday={cadence?.check_in_weekday??null}
