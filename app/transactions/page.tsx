...
export default async function TransactionsPage({searchParams}:{searchParams:Promise<Record<string,string|string[]|undefined>>}) {
  ...
  return <AuthenticatedPage className="transactions-page premium-utility" eyebrow="Your activity" title={historical?'Review older purchases':'Transactions'} description="Your money in and out, organized in one place.">
