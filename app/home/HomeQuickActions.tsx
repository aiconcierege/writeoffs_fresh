...
export function HomeQuickActions({business}:{business:boolean}){return <section className="home-add" aria-labelledby="home-add-heading"><div className="home-add-heading"><h2 id="home-add-heading">Tell Betti anytime</h2></div><div className="home-add-list">
 <Link href="/import" className="home-add-action"><Icon name="receipt"/><strong>Send documents</strong></Link>
 <Link href="/mileage" className="home-add-action"><Icon name="miles"/><strong>Add mileage</strong></Link>
 <Link href={business?'/money':'/money?kind=spent'} className="home-add-action"><Icon name="money"/><strong>Add money</strong></Link>
 <Link href="/invoices" className="home-add-action"><Icon name="invoice"/><strong>Create invoice</strong></Link>
 </div></section>}
