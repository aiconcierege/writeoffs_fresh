...
export function HistoricalMileageFollowUp(props:{joinedMonth:string;vehicles:Array<{id:string;display_name:string}>;expectedId:string;initialPeriods?:HistoricalMileagePeriod[]}) {
