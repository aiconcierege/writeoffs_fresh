...
const dir = process.argv.includes('--custom') ? '/private/tmp/writeoffs-plaid-transactions-custom-proof' : '/private/tmp/writeoffs-plaid-transactions-proof'
...
try {
  ...
  if (process.argv.includes('--create')) {
    ...
    if (process.argv.includes('--cross-tenant')) {
